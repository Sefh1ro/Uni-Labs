...
img = Image.open("foto.jpg")
white = Image.new("RGB", (img.size[0], 100), (255, 255, 255))  # Створюємо білу смугу шириною з картинку, висотою 100
mask = Image.new("L", (img.size[0], 100), 64)  # Маска прозорості: 0=повна прозорість, 255=повна непрозорість
img.paste(white, (0, 0), mask)  # Вставляємо білу смугу з прозорістю у верхню частину
img.show()
